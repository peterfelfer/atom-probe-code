...
% exports pos file's coordinates to an obj file, so that it can be read
% into various computer graphics programs such as Blender.
% pos is the pos variable to be exported
% fileName the name of the file
% species is optional. format: cellstr {'Fe','Cr',...} or string ["Fe", "Cr",..]
% if species is an empty cell variable {}, an dialoge will pop up with the possible selections
%
